 ...
 * C source code generated on : Fri Aug 30 11:14:25 2019
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Sum: '<S5>/Sum'
     */
    heli_q8_B.k_pp = (heli_q8_B.PitchCounttorad - heli_q8_P.Constant1_Value) *
      heli_q8_P.k_pp_Gain;
  }
   ...
   *  Gain: '<S5>/k_pd'
   */
  rtb_Frontgain = heli_q8_P.k_pd_Gain * heli_q8_B.PitchTransferFcn -
    heli_q8_B.k_pp;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    rtb_DeadZoney = heli_q8_B.Sum - heli_q8_P.Constant_Value;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<Root>/k_d' */
    heli_q8_B.k_d = heli_q8_P.k_d_Gain * heli_q8_B.Joystick_gain_x;
    ...
    /* Gain: '<Root>/k_f' */
    heli_q8_B.k_f = heli_q8_P.k_f_Gain * heli_q8_B.Joystick_gain_y;
  }
}
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1593725640U);
  heli_q8_M->Sizes.checksums[1] = (598223763U);
  heli_q8_M->Sizes.checksums[2] = (425012227U);
  heli_q8_M->Sizes.checksums[3] = (440011776U);
