...
#ifndef RTW_HEADER_three_part_three_h_
#define RTW_HEADER_three_part_three_h_
#include <string.h>
#ifndef three_part_three_COMMON_INCLUDES_
# define three_part_three_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* three_part_three_COMMON_INCLUDES_ */

#include "three_part_three_types.h"
...
#define three_part_three_rtModel       RT_MODEL_three_part_three_T
...
typedef struct {
  ...
  real_T Integrator_CSTATE_c;          /* '<Root>/Integrator' */
} X_three_part_three_T;
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_c;       /* '<Root>/Integrator' */
} XDis_three_part_three_T;
...
#define rtB                            three_part_three_B
#define BlockIO                        B_three_part_three_T
#define rtX                            three_part_three_X
#define ContinuousStates               X_three_part_three_T
#define rtXdot                         three_part_three_XDot
#define StateDerivatives               XDot_three_part_three_T
#define tXdis                          three_part_three_XDis
#define StateDisabled                  XDis_three_part_three_T
#define rtP                            three_part_three_P
#define Parameters                     P_three_part_three_T
#define rtDWork                        three_part_three_DW
#define D_Work                         DW_three_part_three_T

/* Parameters (auto storage) */
struct P_three_part_three_T_ {
  ...
  real_T HILInitialize_set_other_outpu_o;/* Mask Parameter: HILInitialize_set_other_outpu_o
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  real_T HILInitialize_set_other_outp_o3;/* Mask Parameter: HILInitialize_set_other_outp_o3
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  ...
  boolean_T HILInitialize_set_clock_params_;/* Mask Parameter: HILInitialize_set_clock_params_
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_clock_param_i;/* Mask Parameter: HILInitialize_set_clock_param_i
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_digital_out_j;/* Mask Parameter: HILInitialize_set_digital_out_j
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_digital_ou_eo;/* Mask Parameter: HILInitialize_set_digital_ou_eo
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_digital_out_f;/* Mask Parameter: HILInitialize_set_digital_out_f
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_digital_ou_j3;/* Mask Parameter: HILInitialize_set_digital_ou_j3
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_encoder_par_j;/* Mask Parameter: HILInitialize_set_encoder_par_j
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_other_outpu_f;/* Mask Parameter: HILInitialize_set_other_outpu_f
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  real_T Integrator_IC_k;              /* Expression: 0
                                        ...
                                        */
  real_T k_d_Gain;                     /* Expression: 1
                                        * Referenced by: '<Root>/k_d'
                                        */
  real_T k_f_Gain;                     /* Expression: -1.75
...
struct tag_RTM_three_part_three_T {
  const char_T *path;
...
extern P_three_part_three_T three_part_three_P;

/* Block signals (auto storage) */
extern B_three_part_three_T three_part_three_B;

/* Continuous states (auto storage) */
extern X_three_part_three_T three_part_three_X;

/* Block states (auto storage) */
extern DW_three_part_three_T three_part_three_DW;
...
extern void three_part_three_initialize(void);
extern void three_part_three_output0(void);
extern void three_part_three_update0(void);
extern void three_part_three_output(int_T tid);
extern void three_part_three_update(int_T tid);
extern void three_part_three_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern three_part_three_rtModel *three_part_three(void);
...
extern RT_MODEL_three_part_three_T *const three_part_three_M;
 ...
 *
 * '<Root>' : 'three_part_three'
 * '<S1>'   : 'three_part_three/Conversion'
 * '<S2>'   : 'three_part_three/Elevation controller'
 * '<S3>'   : 'three_part_three/Heli 3D'
 * '<S4>'   : 'three_part_three/Joystick'
 * '<S5>'   : 'three_part_three/Pitch controller'
 * '<S6>'   : 'three_part_three/Subsystem'
 * '<S7>'   : 'three_part_three/Subsystem1'
 * '<S8>'   : 'three_part_three/Subsystem2'
 * '<S9>'   : 'three_part_three/Elevation controller/Elevation controller'
 */
#endif                                 /* RTW_HEADER_three_part_three_h_ */
