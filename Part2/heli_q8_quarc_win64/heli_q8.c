 ...
 * C source code generated on : Fri Sep 13 11:32:32 2019
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Sum: '<S5>/Sum'
     */
    heli_q8_B.k_pp = (heli_q8_P.p_c_Value - heli_q8_B.PitchCounttorad) *
      heli_q8_P.k_pp;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Constant: '<Root>/e_c'
     */
    rtb_DeadZoney = heli_q8_P.e_c_Value - heli_q8_B.Sum;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (683588870U);
  heli_q8_M->Sizes.checksums[1] = (1484466407U);
  heli_q8_M->Sizes.checksums[2] = (583360502U);
  heli_q8_M->Sizes.checksums[3] = (1348358678U);
