 ...
 * C source code generated on : Fri Oct 25 14:31:32 2019
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  /* Sum: '<Root>/Sum' */
  rtb_Sum = heli_q8_B.Gain[0] - rtb_K[0];
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  ...
  /* Sum: '<Root>/Sum2' */
  heli_q8_B.Sum2 = rtb_Sum + heli_q8_B.Constant1;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Sum: '<S3>/Sum' */
    heli_q8_B.Sum = heli_q8_B.ElevationCounttorad;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    for (i = 0; i < 6; i++) {
      for (i_0 = 0; i_0 < 6; i_0++) {
        tmp[i + 6 * i_0] = 0.0;
        for (i_1 = 0; i_1 < 6; i_1++) {
          tmp[i + 6 * i_0] += heli_q8_B.UnitDelay1[6 * i_1 + i] * heli_q8_P.M[6 *
            i_0 + i_1];
        }
      }
    }
    ...
    for (i = 0; i < 6; i++) {
      ...
      for (i_0 = 0; i_0 < 6; i_0++) {
        heli_q8_B.Gain_f[i] += tmp[6 * i_0 + i] * heli_q8_P.v[i_0];
      }
    }
  }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (heli_q8_B.Sum2 - heli_q8_B.Sum1_h) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (heli_q8_B.Sum2 + heli_q8_B.Sum1_h) * heli_q8_P.Backgain_Gain;
  ...
  for (i = 0; i < 6; i++) {
    tmp_0[i] = 0.0;
    tmp_1[i] = 0.0;
    tmp_1[i] += heli_q8_B.Constant2[i] * rtb_Sum;
    tmp_1[i] += heli_q8_B.Constant2[i + 6] * heli_q8_B.Sum1_h;
    for (i_0 = 0; i_0 < 6; i_0++) {
      tmp_0[i] += heli_q8_B.Constant[6 * i_0 + i] * heli_q8_B.UnitDelay[i_0];
      tmp[i + 6 * i_0] = 0.0;
      for (i_1 = 0; i_1 < 6; i_1++) {
        tmp[i + 6 * i_0] += heli_q8_B.Constant[6 * i_1 + i] *
          heli_q8_B.UnitDelay1[6 * i_0 + i_1];
      }
    }

    heli_q8_B.xk1[i] = tmp_0[i] + tmp_1[i];
  }
  ...
  for (i = 0; i < 6; i++) {
    for (i_0 = 0; i_0 < 6; i_0++) {
      rtb_Sum = 0.0;
      for (i_1 = 0; i_1 < 6; i_1++) {
        rtb_Sum += tmp[6 * i_1 + i] * heli_q8_B.Constant[6 * i_1 + i_0];
      }

      heli_q8_B.Pk1[i + 6 * i_0] = heli_q8_B.Constant1_o[6 * i_0 + i] + rtb_Sum;
    }
  }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (2855001471U);
  heli_q8_M->Sizes.checksums[1] = (527459339U);
  heli_q8_M->Sizes.checksums[2] = (1507659635U);
  heli_q8_M->Sizes.checksums[3] = (3689358683U);
  ...
  heli_q8_M->Sizes.numBlocks = (60);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (29);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (315);/* Sum of parameter "widths" */
  return heli_q8_M;
}
