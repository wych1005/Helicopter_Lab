  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_DW.elev_rate_doff_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 16;
	  section.data(2).dtTransOffset = 1;
	
	  ;% heli_q8_DW.gyroencoder_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 17;
	  section.data(3).dtTransOffset = 2;
	
	  ;% heli_q8_DW.pitch_diff_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 18;
	  section.data(4).dtTransOffset = 3;
	
	  ;% heli_q8_DW.v_s_PWORK.LoggedData
	  ...
	  ;% heli_q8_DW.g_PWORK.LoggedData
	  section.data(16).logicalSrcIdx = 30;
	  section.data(16).dtTransOffset = 15;
	
	  ;% heli_q8_DW.z_PWORK.LoggedData
	  section.data(17).logicalSrcIdx = 31;
	  section.data(17).dtTransOffset = 16;
	
	  ;% heli_q8_DW.elevrate1_PWORK.LoggedData
	  ...
	  ;% heli_q8_DW.travelrate2_PWORK.LoggedData
  ...
  targMap.checksum0 = 156234030;
  targMap.checksum1 = 524205753;
  targMap.checksum2 = 4032509061;
  targMap.checksum3 = 120349340;
