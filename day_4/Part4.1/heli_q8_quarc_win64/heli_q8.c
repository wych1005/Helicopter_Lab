 ...
 * C source code generated on : Fri Oct 11 09:49:31 2019
 *
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (156234030U);
  heli_q8_M->Sizes.checksums[1] = (524205753U);
  heli_q8_M->Sizes.checksums[2] = (4032509061U);
  heli_q8_M->Sizes.checksums[3] = (120349340U);
  ...
  heli_q8_M->Sizes.numBlockPrms = (420);/* Sum of parameter "widths" */
  return heli_q8_M;
}
