...
#ifndef RTW_HEADER_heli_1_h_
#define RTW_HEADER_heli_1_h_
#include <string.h>
#ifndef heli_1_COMMON_INCLUDES_
# define heli_1_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* heli_1_COMMON_INCLUDES_ */

#include "heli_1_types.h"
...
#define heli_1_rtModel                 RT_MODEL_heli_1_T
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } analytic_PWORK;                    /* '<Root>/analytic' */

  struct {
    void *LoggedData;
  } differance_PWORK;                  /* '<Root>/differance ' */
...
#define rtB                            heli_1_B
#define BlockIO                        B_heli_1_T
#define rtX                            heli_1_X
#define ContinuousStates               X_heli_1_T
#define rtXdot                         heli_1_XDot
#define StateDerivatives               XDot_heli_1_T
#define tXdis                          heli_1_XDis
#define StateDisabled                  XDis_heli_1_T
#define rtP                            heli_1_P
#define Parameters                     P_heli_1_T
#define rtDWork                        heli_1_DW
#define D_Work                         DW_heli_1_T
...
struct P_heli_1_T_ {
  ...
  real_T k_1;                          /* Variable: k_1
                                        * Referenced by: '<S1>/k_1'
                                        */
  real_T k_2;                          /* Variable: k_2
                                        * Referenced by: '<S1>/k_2'
                                        */
  real_T k_3;                          /* Variable: k_3
                                        * Referenced by: '<S1>/k_3'
                                        */
  ...
  real_T Gainy_Gain;                   /* Expression: 10/9
                                        ...
                                        */
  real_T k_y_Gain;                     /* Expression: 8
                                        * Referenced by: '<Root>/k_y'
                                        */
...
extern P_heli_1_T heli_1_P;

/* Block signals (auto storage) */
extern B_heli_1_T heli_1_B;

/* Continuous states (auto storage) */
extern X_heli_1_T heli_1_X;

/* Block states (auto storage) */
extern DW_heli_1_T heli_1_DW;
...
extern void heli_1_initialize(void);
extern void heli_1_output0(void);
extern void heli_1_update0(void);
extern void heli_1_output(int_T tid);
extern void heli_1_update(int_T tid);
extern void heli_1_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_1_rtModel *heli_1(void);
...
extern RT_MODEL_heli_1_T *const heli_1_M;
 ...
 * '<Root>' : 'heli_1'
 * '<S1>'   : 'heli_1/Analytic'
 * '<S2>'   : 'heli_1/Conversion'
 * '<S3>'   : 'heli_1/Heli 3D'
 * '<S4>'   : 'heli_1/Joystick'
 */
#endif                                 /* RTW_HEADER_heli_1_h_ */
