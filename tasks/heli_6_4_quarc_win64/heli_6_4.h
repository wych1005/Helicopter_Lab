...
#ifndef RTW_HEADER_heli_6_4_h_
#define RTW_HEADER_heli_6_4_h_
#include <math.h>
#include <string.h>
#ifndef heli_6_4_COMMON_INCLUDES_
# define heli_6_4_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* heli_6_4_COMMON_INCLUDES_ */

#include "heli_6_4_types.h"
...
#define heli_6_4_rtModel               RT_MODEL_heli_6_4_T
...
typedef struct {
  real_T UnitDelay1[36];               /* '<S8>/Unit Delay1' */
  real_T Gain[6];                      /* '<S11>/Gain' */
  ...
  real_T Constant[36];                 /* '<S8>/Constant' */
  real_T Constant1_o[36];              /* '<S8>/Constant1' */
  real_T Constant2[12];                /* '<S8>/Constant2' */
  real_T Constant3[30];                /* '<S8>/Constant3' */
  real_T Constant4[25];                /* '<S8>/Constant4' */
  real_T pp;                           /* '<S9>/pp' */
  real_T ee;                           /* '<S9>/ee' */
  real_T xk1[6];                       /* '<S8>/MATLAB Function' */
  real_T Pk1[36];                      /* '<S8>/MATLAB Function' */
...
#define rtB                            heli_6_4_B
#define BlockIO                        B_heli_6_4_T
#define rtX                            heli_6_4_X
#define ContinuousStates               X_heli_6_4_T
#define rtXdot                         heli_6_4_XDot
#define StateDerivatives               XDot_heli_6_4_T
#define tXdis                          heli_6_4_XDis
#define StateDisabled                  XDis_heli_6_4_T
#define rtP                            heli_6_4_P
#define Parameters                     P_heli_6_4_T
#define rtDWork                        heli_6_4_DW
#define D_Work                         DW_heli_6_4_T

/* Parameters (auto storage) */
struct P_heli_6_4_T_ {
...
extern P_heli_6_4_T heli_6_4_P;

/* Block signals (auto storage) */
extern B_heli_6_4_T heli_6_4_B;

/* Continuous states (auto storage) */
extern X_heli_6_4_T heli_6_4_X;

/* Block states (auto storage) */
extern DW_heli_6_4_T heli_6_4_DW;
...
extern void heli_6_4_initialize(void);
extern void heli_6_4_output0(void);
extern void heli_6_4_update0(void);
extern void heli_6_4_output(int_T tid);
extern void heli_6_4_update(int_T tid);
extern void heli_6_4_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_6_4_rtModel *heli_6_4(void);
...
extern RT_MODEL_heli_6_4_T *const heli_6_4_M;
 ...
 *
 * '<Root>' : 'heli_6_4'
 * '<S1>'   : 'heli_6_4/Conversion'
 * '<S2>'   : 'heli_6_4/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S3>'   : 'heli_6_4/Heli 3D'
 * '<S4>'   : 'heli_6_4/IMU'
 * '<S5>'   : 'heli_6_4/Joystick'
 * '<S6>'   : 'heli_6_4/Subsystem'
 * '<S7>'   : 'heli_6_4/Subsystem1'
 * '<S8>'   : 'heli_6_4/Subsystem2'
 * '<S9>'   : 'heli_6_4/Subsystem3'
 * '<S10>'  : 'heli_6_4/Subsystem4'
 * '<S11>'  : 'heli_6_4/Subsystem5'
 * '<S12>'  : 'heli_6_4/Subsystem2/MATLAB Function'
 */
#endif                                 /* RTW_HEADER_heli_6_4_h_ */
