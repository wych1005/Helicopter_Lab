...
#ifndef RTW_HEADER_heli_6_5_h_
#define RTW_HEADER_heli_6_5_h_
#include <math.h>
#include <string.h>
#ifndef heli_6_5_COMMON_INCLUDES_
# define heli_6_5_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* heli_6_5_COMMON_INCLUDES_ */

#include "heli_6_5_types.h"
...
#define heli_6_5_rtModel               RT_MODEL_heli_6_5_T
...
typedef struct {
  ...
  real_T UnitDelay1[36];               /* '<S10>/Unit Delay1' */
  real_T xk1[6];                       /* '<S10>/MATLAB Function' */
  real_T Sum_i;                        /* '<S9>/Sum' */
...
typedef struct {
  ...
  real_T UnitDelay1_DSTATE[36];        /* '<S10>/Unit Delay1' */
  ...
  struct {
    void *LoggedData;
  } p_diag_PWORK;                      /* '<S8>/p_diag' */

  struct {
    void *LoggedData;
  } diff_PWORK;                        /* '<Root>/diff' */

  struct {
    void *LoggedData;
  } enc_trav_PWORK;                    /* '<Root>/enc_trav' */

  struct {
    void *LoggedData;
  } kalman_PWORK;                      /* '<Root>/kalman' */

  struct {
    void *LoggedData;
  } new_data_PWORK;                    /* '<Root>/new_data' */
...
#define rtB                            heli_6_5_B
#define BlockIO                        B_heli_6_5_T
#define rtX                            heli_6_5_X
#define ContinuousStates               X_heli_6_5_T
#define rtXdot                         heli_6_5_XDot
#define StateDerivatives               XDot_heli_6_5_T
#define tXdis                          heli_6_5_XDis
#define StateDisabled                  XDis_heli_6_5_T
#define rtP                            heli_6_5_P
#define Parameters                     P_heli_6_5_T
#define rtDWork                        heli_6_5_DW
#define D_Work                         DW_heli_6_5_T
#define rtPrevZCSigState               heli_6_5_PrevZCX
#define PrevZCSigStates                PrevZCX_heli_6_5_T

/* Parameters (auto storage) */
struct P_heli_6_5_T_ {
  ...
  real_T PitchCounttorad_Gain;         /* Expression: -2*pi /4096
                                        ...
                                        */
  real_T Constant1_Value_o;            /* Expression: -0.16
  ...
  real_T PitchTransferFcn_D;           /* Computed Parameter: PitchTransferFcn_D
                                        * Referenced by: '<S3>/Pitch: Transfer Fcn'
                                        */
  real_T Constant_Value_b;             /* Expression: 0.54
...
extern P_heli_6_5_T heli_6_5_P;

/* Block signals (auto storage) */
extern B_heli_6_5_T heli_6_5_B;

/* Continuous states (auto storage) */
extern X_heli_6_5_T heli_6_5_X;

/* Block states (auto storage) */
extern DW_heli_6_5_T heli_6_5_DW;
...
/* Zero-crossing (trigger) state */
extern PrevZCX_heli_6_5_T heli_6_5_PrevZCX;

/* Model entry point functions */
extern void heli_6_5_initialize(void);
extern void heli_6_5_output0(void);
extern void heli_6_5_update0(void);
extern void heli_6_5_output(int_T tid);
extern void heli_6_5_update(int_T tid);
extern void heli_6_5_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_6_5_rtModel *heli_6_5(void);
...
extern RT_MODEL_heli_6_5_T *const heli_6_5_M;
 ...
 *
 * '<Root>' : 'heli_6_5'
 * '<S1>'   : 'heli_6_5/Conversion'
 * '<S2>'   : 'heli_6_5/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S3>'   : 'heli_6_5/Heli 3D'
 * '<S4>'   : 'heli_6_5/IMU'
 * '<S5>'   : 'heli_6_5/Joystick'
 * '<S6>'   : 'heli_6_5/Subsystem3'
 * '<S7>'   : 'heli_6_5/Subsystem4'
 * '<S8>'   : 'heli_6_5/Subsystem5'
 * '<S9>'   : 'heli_6_5/Subsystem6'
 * '<S10>'  : 'heli_6_5/Triggered Subsystem'
 * '<S11>'  : 'heli_6_5/Subsystem6/Subsystem'
 * '<S12>'  : 'heli_6_5/Subsystem6/Subsystem1'
 * '<S13>'  : 'heli_6_5/Triggered Subsystem/MATLAB Function'
 */
#endif                                 /* RTW_HEADER_heli_6_5_h_ */
