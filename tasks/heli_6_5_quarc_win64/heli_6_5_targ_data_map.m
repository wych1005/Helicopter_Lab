  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% heli_6_5_P.HILInitialize_analog_input_maxi
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 236;
	
	  ;% heli_6_5_P.HILInitialize_analog_input_mini
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 237;
	
	  ;% heli_6_5_P.HILInitialize_analog_output_max
	  section.data(17).logicalSrcIdx = 16;
	  section.data(17).dtTransOffset = 238;
	
	  ;% heli_6_5_P.HILInitialize_analog_output_min
	  section.data(18).logicalSrcIdx = 17;
	  section.data(18).dtTransOffset = 239;
	
	  ;% heli_6_5_P.HILInitialize_final_analog_outp
	  section.data(19).logicalSrcIdx = 18;
	  section.data(19).dtTransOffset = 240;
	
	  ;% heli_6_5_P.HILInitialize_final_pwm_outputs
	  section.data(20).logicalSrcIdx = 19;
	  section.data(20).dtTransOffset = 241;
	
	  ;% heli_6_5_P.HILInitialize_initial_analog_ou
	  section.data(21).logicalSrcIdx = 20;
	  section.data(21).dtTransOffset = 242;
	
	  ;% heli_6_5_P.HILInitialize_initial_pwm_outpu
	  ...
	  ;% heli_6_5_P.HILInitialize_pwm_leading_deadb
	  section.data(24).logicalSrcIdx = 23;
	  section.data(24).dtTransOffset = 245;
	
	  ;% heli_6_5_P.HILInitialize_pwm_trailing_dead
	  section.data(25).logicalSrcIdx = 24;
	  section.data(25).dtTransOffset = 246;
	
	  ;% heli_6_5_P.HILInitialize_set_other_outputs
	  section.data(26).logicalSrcIdx = 25;
	  section.data(26).dtTransOffset = 247;
	
	  ;% heli_6_5_P.HILInitialize_set_other_outpu_b
	  section.data(27).logicalSrcIdx = 26;
	  section.data(27).dtTransOffset = 248;
	
	  ;% heli_6_5_P.HILInitialize_set_other_outpu_n
	  section.data(28).logicalSrcIdx = 27;
	  section.data(28).dtTransOffset = 249;
	
	  ;% heli_6_5_P.HILInitialize_set_other_outp_b2
	  section.data(29).logicalSrcIdx = 28;
	  section.data(29).dtTransOffset = 250;
	
	  ;% heli_6_5_P.HILInitialize_watchdog_analog_o
	  section.data(30).logicalSrcIdx = 29;
	  section.data(30).dtTransOffset = 251;
	
	  ;% heli_6_5_P.HILInitialize_watchdog_pwm_outp
	  ...
	  ;% heli_6_5_P.HILReadEncoderTimebase_clock
	  section.data(1).logicalSrcIdx = 31;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_6_5_P.HILInitialize_hardware_clocks
	  section.data(2).logicalSrcIdx = 32;
	  section.data(2).dtTransOffset = 1;
	
	  ;% heli_6_5_P.HILInitialize_initial_encoder_c
	  section.data(3).logicalSrcIdx = 33;
	  section.data(3).dtTransOffset = 4;
	
	  ;% heli_6_5_P.HILInitialize_pwm_alignment
	  section.data(4).logicalSrcIdx = 34;
	  section.data(4).dtTransOffset = 5;
	
	  ;% heli_6_5_P.HILInitialize_pwm_configuration
	  section.data(5).logicalSrcIdx = 35;
	  section.data(5).dtTransOffset = 6;
	
	  ;% heli_6_5_P.HILInitialize_pwm_modes
	  section.data(6).logicalSrcIdx = 36;
	  section.data(6).dtTransOffset = 7;
	
	  ;% heli_6_5_P.HILInitialize_pwm_polarity
	  section.data(7).logicalSrcIdx = 37;
	  section.data(7).dtTransOffset = 8;
	
	  ;% heli_6_5_P.HILInitialize_watchdog_digital_
	  ...
	  ;% heli_6_5_P.HILInitialize_analog_input_chan
	  ...
	  ;% heli_6_5_P.HILReadEncoderTimebase_channels
	  section.data(3).logicalSrcIdx = 41;
	  section.data(3).dtTransOffset = 16;
	
	  ;% heli_6_5_P.HILWriteAnalog_channels
	  section.data(4).logicalSrcIdx = 42;
	  section.data(4).dtTransOffset = 19;
	
	  ;% heli_6_5_P.HILInitialize_encoder_channels
	  ...
	  ;% heli_6_5_P.HILInitialize_quadrature
	  ...
	  ;% heli_6_5_P.HILInitialize_active
	  section.data(1).logicalSrcIdx = 47;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_6_5_P.HILInitialize_final_digital_out
	  section.data(2).logicalSrcIdx = 48;
	  section.data(2).dtTransOffset = 1;
	
	  ;% heli_6_5_P.HILInitialize_initial_digital_o
	  section.data(3).logicalSrcIdx = 49;
	  section.data(3).dtTransOffset = 2;
	
	  ;% heli_6_5_P.HILInitialize_set_analog_input_
	  section.data(4).logicalSrcIdx = 50;
	  section.data(4).dtTransOffset = 3;
	
	  ;% heli_6_5_P.HILInitialize_set_analog_inpu_n
	  section.data(5).logicalSrcIdx = 51;
	  section.data(5).dtTransOffset = 4;
	
	  ;% heli_6_5_P.HILInitialize_set_analog_output
	  section.data(6).logicalSrcIdx = 52;
	  section.data(6).dtTransOffset = 5;
	
	  ;% heli_6_5_P.HILInitialize_set_analog_outp_f
	  section.data(7).logicalSrcIdx = 53;
	  section.data(7).dtTransOffset = 6;
	
	  ;% heli_6_5_P.HILInitialize_set_analog_outp_d
	  section.data(8).logicalSrcIdx = 54;
	  section.data(8).dtTransOffset = 7;
	
	  ;% heli_6_5_P.HILInitialize_set_analog_outp_m
	  section.data(9).logicalSrcIdx = 55;
	  section.data(9).dtTransOffset = 8;
	
	  ;% heli_6_5_P.HILInitialize_set_analog_outp_j
	  section.data(10).logicalSrcIdx = 56;
	  section.data(10).dtTransOffset = 9;
	
	  ;% heli_6_5_P.HILInitialize_set_analog_out_jf
	  section.data(11).logicalSrcIdx = 57;
	  section.data(11).dtTransOffset = 10;
	
	  ;% heli_6_5_P.HILInitialize_set_analog_outp_h
	  section.data(12).logicalSrcIdx = 58;
	  section.data(12).dtTransOffset = 11;
	
	  ;% heli_6_5_P.HILInitialize_set_clock_frequen
	  section.data(13).logicalSrcIdx = 59;
	  section.data(13).dtTransOffset = 12;
	
	  ;% heli_6_5_P.HILInitialize_set_clock_frequ_h
	  section.data(14).logicalSrcIdx = 60;
	  section.data(14).dtTransOffset = 13;
	
	  ;% heli_6_5_P.HILInitialize_set_clock_params_
	  section.data(15).logicalSrcIdx = 61;
	  section.data(15).dtTransOffset = 14;
	
	  ;% heli_6_5_P.HILInitialize_set_clock_param_a
	  section.data(16).logicalSrcIdx = 62;
	  section.data(16).dtTransOffset = 15;
	
	  ;% heli_6_5_P.HILInitialize_set_digital_outpu
	  section.data(17).logicalSrcIdx = 63;
	  section.data(17).dtTransOffset = 16;
	
	  ;% heli_6_5_P.HILInitialize_set_digital_out_p
	  section.data(18).logicalSrcIdx = 64;
	  section.data(18).dtTransOffset = 17;
	
	  ;% heli_6_5_P.HILInitialize_set_digital_out_l
	  section.data(19).logicalSrcIdx = 65;
	  section.data(19).dtTransOffset = 18;
	
	  ;% heli_6_5_P.HILInitialize_set_digital_out_f
	  section.data(20).logicalSrcIdx = 66;
	  section.data(20).dtTransOffset = 19;
	
	  ;% heli_6_5_P.HILInitialize_set_digital_out_e
	  section.data(21).logicalSrcIdx = 67;
	  section.data(21).dtTransOffset = 20;
	
	  ;% heli_6_5_P.HILInitialize_set_digital_out_j
	  section.data(22).logicalSrcIdx = 68;
	  section.data(22).dtTransOffset = 21;
	
	  ;% heli_6_5_P.HILInitialize_set_digital_out_h
	  section.data(23).logicalSrcIdx = 69;
	  section.data(23).dtTransOffset = 22;
	
	  ;% heli_6_5_P.HILInitialize_set_encoder_count
	  section.data(24).logicalSrcIdx = 70;
	  section.data(24).dtTransOffset = 23;
	
	  ;% heli_6_5_P.HILInitialize_set_encoder_cou_n
	  section.data(25).logicalSrcIdx = 71;
	  section.data(25).dtTransOffset = 24;
	
	  ;% heli_6_5_P.HILInitialize_set_encoder_param
	  section.data(26).logicalSrcIdx = 72;
	  section.data(26).dtTransOffset = 25;
	
	  ;% heli_6_5_P.HILInitialize_set_encoder_par_o
	  section.data(27).logicalSrcIdx = 73;
	  section.data(27).dtTransOffset = 26;
	
	  ;% heli_6_5_P.HILInitialize_set_other_outpu_a
	  section.data(28).logicalSrcIdx = 74;
	  section.data(28).dtTransOffset = 27;
	
	  ;% heli_6_5_P.HILInitialize_set_pwm_outputs_a
	  section.data(29).logicalSrcIdx = 75;
	  section.data(29).dtTransOffset = 28;
	
	  ;% heli_6_5_P.HILInitialize_set_pwm_outputs_k
	  section.data(30).logicalSrcIdx = 76;
	  section.data(30).dtTransOffset = 29;
	
	  ;% heli_6_5_P.HILInitialize_set_pwm_outputs_c
	  section.data(31).logicalSrcIdx = 77;
	  section.data(31).dtTransOffset = 30;
	
	  ;% heli_6_5_P.HILInitialize_set_pwm_outputs_d
	  section.data(32).logicalSrcIdx = 78;
	  section.data(32).dtTransOffset = 31;
	
	  ;% heli_6_5_P.HILInitialize_set_pwm_outputs_o
	  section.data(33).logicalSrcIdx = 79;
	  section.data(33).dtTransOffset = 32;
	
	  ;% heli_6_5_P.HILInitialize_set_pwm_params_at
	  section.data(34).logicalSrcIdx = 80;
	  section.data(34).dtTransOffset = 33;
	
	  ;% heli_6_5_P.HILInitialize_set_pwm_params__o
	  ...
	  ;% heli_6_5_P.Constant2_Value
	  section.data(1).logicalSrcIdx = 82;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_6_5_P.RateTransitionx_X0
	  ...
	  ;% heli_6_5_P.Gainx_Gain
	  section.data(5).logicalSrcIdx = 86;
	  section.data(5).dtTransOffset = 4;
	
	  ;% heli_6_5_P.RateTransitiony_X0
	  ...
	  ;% heli_6_5_P.StreamCall1_SendBufferSize
	  ...
	  ;% heli_6_5_P.StreamFormattedWrite_MaxUnits
	  ...
	  ;% heli_6_5_P.GameController_BufferSize
	  ...
	  ;% heli_6_5_P.StringConstant_Value
	  section.data(1).logicalSrcIdx = 119;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_6_5_P.StreamCall1_URI
	  ...
	  ;% heli_6_5_P.GameController_ControllerNumber
	  ...
	  ;% heli_6_5_P.HILReadEncoderTimebase_Active
	  section.data(1).logicalSrcIdx = 123;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_6_5_P.StreamCall1_Active
	  section.data(2).logicalSrcIdx = 124;
	  section.data(2).dtTransOffset = 1;
	
	  ;% heli_6_5_P.HILWriteAnalog_Active
	  section.data(3).logicalSrcIdx = 125;
	  section.data(3).dtTransOffset = 2;
	
	  ;% heli_6_5_P.GameController_AutoCenter
	  section.data(4).logicalSrcIdx = 126;
	  section.data(4).dtTransOffset = 3;
	
	  ;% heli_6_5_P.GameController_Enabled
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (heli_6_5_B)
    ;%
      section.nData     = 22;
      section.data(22)  = dumData; %prealloc
      
	  ;% heli_6_5_B.UnitDelay
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_6_5_B.RateTransitionx
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 6;
	
	  ;% heli_6_5_B.Joystick_gain_x
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 7;
	
	  ;% heli_6_5_B.RateTransitiony
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 8;
	
	  ;% heli_6_5_B.Joystick_gain_y
	  section.data(5).logicalSrcIdx = 4;
	  ...
	  ;% heli_6_5_B.ElevationTransferFcn
	  section.data(14).logicalSrcIdx = 13;
	  ...
	  ;% heli_6_5_B.GameController_o4
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 30;
	
	  ;% heli_6_5_B.GameController_o5
	  section.data(17).logicalSrcIdx = 16;
	  section.data(17).dtTransOffset = 31;
	
	  ;% heli_6_5_B.UnitDelay1
	  section.data(18).logicalSrcIdx = 17;
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (heli_6_5_DW)
    ;%
      section.nData     = 13;
      section.data(13)  = dumData; %prealloc
      
	  ;% heli_6_5_DW.UnitDelay_DSTATE
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_6_5_DW.UnitDelay1_DSTATE
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 6;
	
	  ;% heli_6_5_DW.HILInitialize_AIMinimums
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 42;
	
	  ;% heli_6_5_DW.HILInitialize_AIMaximums
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 50;
	
	  ;% heli_6_5_DW.HILInitialize_AOMinimums
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 58;
	
	  ;% heli_6_5_DW.HILInitialize_AOMaximums
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 66;
	
	  ;% heli_6_5_DW.HILInitialize_AOVoltages
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 74;
	
	  ;% heli_6_5_DW.HILInitialize_FilterFrequency
	  section.data(8).logicalSrcIdx = 7;
	  section.data(8).dtTransOffset = 82;
	
	  ;% heli_6_5_DW.HILInitialize_POSortedFreqs
	  section.data(9).logicalSrcIdx = 8;
	  section.data(9).dtTransOffset = 90;
	
	  ;% heli_6_5_DW.HILInitialize_POValues
	  section.data(10).logicalSrcIdx = 9;
	  section.data(10).dtTransOffset = 98;
	
	  ;% heli_6_5_DW.RateTransitionx_Buffer0
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 106;
	
	  ;% heli_6_5_DW.RateTransitiony_Buffer0
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 107;
	
	  ;% heli_6_5_DW.HILWriteAnalog_Buffer
	  section.data(13).logicalSrcIdx = 12;
	  ...
	  ;% heli_6_5_DW.p_diag_PWORK.LoggedData
	  section.data(1).logicalSrcIdx = 17;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_6_5_DW.diff_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 18;
	  section.data(2).dtTransOffset = 1;
	
	  ;% heli_6_5_DW.enc_trav_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 19;
	  section.data(3).dtTransOffset = 2;
	
	  ;% heli_6_5_DW.kalman_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 20;
	  section.data(4).dtTransOffset = 3;
	
	  ;% heli_6_5_DW.new_data_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 21;
	  section.data(5).dtTransOffset = 4;
	
	  ;% heli_6_5_DW.ElevationScoperads_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 22;
	  section.data(6).dtTransOffset = 5;
	
	  ;% heli_6_5_DW.ElevationScoperad_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 23;
	  section.data(7).dtTransOffset = 6;
	
	  ;% heli_6_5_DW.PitchScoperad_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 24;
	  section.data(8).dtTransOffset = 7;
	
	  ;% heli_6_5_DW.PtichrateScoperads_PWORK.LoggedData
	  section.data(9).logicalSrcIdx = 25;
	  section.data(9).dtTransOffset = 8;
	
	  ;% heli_6_5_DW.TravelrateScoperads_PWORK.LoggedData
	  section.data(10).logicalSrcIdx = 26;
	  section.data(10).dtTransOffset = 9;
	
	  ;% heli_6_5_DW.TravelScoperad_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 27;
	  section.data(11).dtTransOffset = 10;
	
	  ;% heli_6_5_DW.HILWriteAnalog_PWORK
	  section.data(12).logicalSrcIdx = 28;
	  section.data(12).dtTransOffset = 11;
	
	  ;% heli_6_5_DW.Connected_PWORK.LoggedData
	  section.data(13).logicalSrcIdx = 29;
	  section.data(13).dtTransOffset = 12;
	
	  ;% heli_6_5_DW.XScope_PWORK.LoggedData
	  section.data(14).logicalSrcIdx = 30;
	  section.data(14).dtTransOffset = 13;
	
	  ;% heli_6_5_DW.YScope_PWORK.LoggedData
	  ...
	  ;% heli_6_5_DW.HILInitialize_ClockModes
	  section.data(1).logicalSrcIdx = 32;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_6_5_DW.HILInitialize_QuadratureModes
	  section.data(2).logicalSrcIdx = 33;
	  section.data(2).dtTransOffset = 3;
	
	  ;% heli_6_5_DW.HILInitialize_InitialEICounts
	  section.data(3).logicalSrcIdx = 34;
	  section.data(3).dtTransOffset = 11;
	
	  ;% heli_6_5_DW.HILInitialize_POModeValues
	  section.data(4).logicalSrcIdx = 35;
	  section.data(4).dtTransOffset = 19;
	
	  ;% heli_6_5_DW.HILInitialize_POAlignValues
	  section.data(5).logicalSrcIdx = 36;
	  section.data(5).dtTransOffset = 27;
	
	  ;% heli_6_5_DW.HILInitialize_POPolarityVals
	  section.data(6).logicalSrcIdx = 37;
	  section.data(6).dtTransOffset = 35;
	
	  ;% heli_6_5_DW.HILReadEncoderTimebase_Buffer
	  ...
	  ;% heli_6_5_DW.HILInitialize_POSortedChans
	  section.data(1).logicalSrcIdx = 39;
	  section.data(1).dtTransOffset = 0;
	  ...
	  ;% heli_6_5_DW.Subsystem6_SubsysRanBC
	  section.data(1).logicalSrcIdx = 40;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_6_5_DW.TriggeredSubsystem_SubsysRanBC
  ...
  targMap.checksum0 = 3448498446;
  targMap.checksum1 = 2879067277;
  targMap.checksum2 = 1171563730;
  targMap.checksum3 = 1185534661;
