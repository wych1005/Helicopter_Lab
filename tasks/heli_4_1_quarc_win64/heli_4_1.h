...
#ifndef RTW_HEADER_heli_4_1_h_
#define RTW_HEADER_heli_4_1_h_
#include <string.h>
#ifndef heli_4_1_COMMON_INCLUDES_
# define heli_4_1_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* heli_4_1_COMMON_INCLUDES_ */

#include "heli_4_1_types.h"
...
#define heli_4_1_rtModel               RT_MODEL_heli_4_1_T
...
typedef struct {
  ...
  real_T Sum3;                         /* '<S7>/Sum3' */
  real_T Sum4;                         /* '<S7>/Sum4' */
  uint8_T StreamCall1_o2;              /* '<S3>/Stream Call1' */
} B_heli_4_1_T;
...
typedef struct {
  ...
  t_stream StreamCall1_Stream;         /* '<S3>/Stream Call1' */
  ...
  struct {
    void *LoggedData;
  } elevrate_PWORK;                    /* '<Root>/elev rate' */

  struct {
    void *LoggedData;
  } elev_rate_diff_PWORK;              /* '<Root>/elev_rate_diff' */

  struct {
    void *LoggedData;
  } gyroencoder_PWORK;                 /* '<Root>/gyro//encoder' */
  ...
  struct {
    void *LoggedData;
  } pitch_diff_PWORK;                  /* '<Root>/pitch_diff' */
  ...
  uint8_T StreamCall1_State;           /* '<S3>/Stream Call1' */
} DW_heli_4_1_T;
...
#define rtB                            heli_4_1_B
#define BlockIO                        B_heli_4_1_T
#define rtX                            heli_4_1_X
#define ContinuousStates               X_heli_4_1_T
#define rtXdot                         heli_4_1_XDot
#define StateDerivatives               XDot_heli_4_1_T
#define tXdis                          heli_4_1_XDis
#define StateDisabled                  XDis_heli_4_1_T
#define rtP                            heli_4_1_P
#define Parameters                     P_heli_4_1_T
#define rtDWork                        heli_4_1_DW
#define D_Work                         DW_heli_4_1_T

/* Parameters (auto storage) */
struct P_heli_4_1_T_ {
  ...
  uint32_T StreamFormattedWrite_MaxUnits;/* Computed Parameter: StreamFormattedWrite_MaxUnits
                                          * Referenced by: '<S3>/Stream Formatted Write'
                                          */
...
extern P_heli_4_1_T heli_4_1_P;

/* Block signals (auto storage) */
extern B_heli_4_1_T heli_4_1_B;

/* Continuous states (auto storage) */
extern X_heli_4_1_T heli_4_1_X;

/* Block states (auto storage) */
extern DW_heli_4_1_T heli_4_1_DW;
...
extern void heli_4_1_initialize(void);
extern void heli_4_1_output0(void);
extern void heli_4_1_update0(void);
extern void heli_4_1_output(int_T tid);
extern void heli_4_1_update(int_T tid);
extern void heli_4_1_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_4_1_rtModel *heli_4_1(void);
...
extern RT_MODEL_heli_4_1_T *const heli_4_1_M;
 ...
 *
 * '<Root>' : 'heli_4_1'
 * '<S1>'   : 'heli_4_1/Conversion'
 * '<S2>'   : 'heli_4_1/Heli 3D'
 * '<S3>'   : 'heli_4_1/IMU'
 * '<S4>'   : 'heli_4_1/Joystick'
 * '<S5>'   : 'heli_4_1/Subsystem'
 * '<S6>'   : 'heli_4_1/Subsystem1'
 * '<S7>'   : 'heli_4_1/Subsystem2'
 */
#endif                                 /* RTW_HEADER_heli_4_1_h_ */
