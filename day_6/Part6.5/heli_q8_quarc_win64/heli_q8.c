 ...
 * C source code generated on : Fri Nov 08 21:01:36 2019
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  srClearBC(heli_q8_DW.Subsystem6_SubsysRanBC);
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    if (rtmIsMajorTimeStep(heli_q8_M)) {
      if (heli_q8_B.StreamRead1_o3 && (heli_q8_PrevZCX.Subsystem6_Trig_ZCE !=
           POS_ZCSIG)) {
        /* Gain: '<S12>/K' incorporates:
         *  SignalConversion: '<S12>/TmpSignal ConversionAtKInport1'
         */
        for (i = 0; i < 2; i++) {
          rtb_K[i] = heli_q8_P.K[i + 4] * heli_q8_B.UnitDelay[3] +
         ...
         */
        heli_q8_B.Sum_i = (heli_q8_P.F[0] * heli_q8_B.Joystick_gain_x +
                           heli_q8_P.F[2] * heli_q8_B.Joystick_gain_y) - rtb_K[0];

        /* Sum: '<S9>/Sum1' incorporates:
         *  Gain: '<S11>/Gain'
         *  SignalConversion: '<S11>/TmpSignal ConversionAtGainInport1'
         */
        heli_q8_B.Sum1_h = (heli_q8_P.F[1] * heli_q8_B.Joystick_gain_x +
                            heli_q8_P.F[3] * heli_q8_B.Joystick_gain_y) - rtb_K
          [1];

        /* Sum: '<S9>/Sum2' incorporates:
         *  Constant: '<S9>/Constant1'
         */
        heli_q8_B.Sum2 = heli_q8_B.Sum_i + heli_q8_P.v_s0;
        heli_q8_DW.Subsystem6_SubsysRanBC = 4;
      }

      heli_q8_PrevZCX.Subsystem6_Trig_ZCE = heli_q8_B.StreamRead1_o3;
    }
    ...
    if (rtmIsMajorTimeStep(heli_q8_M)) {
      if (heli_q8_B.StreamRead1_o3 &&
        ...
        for (i = 0; i < 5; i++) {
          for (i_0 = 0; i_0 < 6; i_0++) {
            Kk_1[i + 5 * i_0] = 0.0;
            for (k = 0; k < 6; k++) {
              Kk_1[i + 5 * i_0] += heli_q8_P.C_d[5 * k + i] *
                heli_q8_B.UnitDelay1[6 * i_0 + k];
            }
          }
        }
        ...
        for (i = 0; i < 5; i++) {
          for (i_0 = 0; i_0 < 5; i_0++) {
            tmp_4 = 0.0;
            for (k = 0; k < 6; k++) {
              tmp_4 += Kk_1[5 * k + i] * heli_q8_P.C_d[5 * k + i_0];
            }

            tmp[i + 5 * i_0] = heli_q8_P.R_d[5 * i_0 + i] + tmp_4;
          }
        }
        ...
        for (i = 0; i < 6; i++) {
          for (i_0 = 0; i_0 < 5; i_0++) {
            Kk_1[i + 6 * i_0] = 0.0;
            for (k = 0; k < 6; k++) {
              Kk_1[i + 6 * i_0] += heli_q8_B.UnitDelay1[6 * k + i] *
        ...
        if (!heli_q8_B.StreamRead1_o3) {
          ...
          for (i = 0; i < 6; i++) {
            for (i_0 = 0; i_0 < 6; i_0++) {
              tmp_4 = 0.0;
              for (k = 0; k < 5; k++) {
                tmp_4 += Kk[6 * k + i] * heli_q8_P.C_d[5 * i_0 + k];
              }
           ...
           */
          tmp_1[0] = 1.0;
          tmp_1[3] = sin(heli_q8_B.UnitDelay[2]) * tan(heli_q8_B.UnitDelay[4]);
          tmp_1[6] = cos(heli_q8_B.UnitDelay[2]) * tan(heli_q8_B.UnitDelay[4]);
          tmp_1[1] = 0.0;
          tmp_1[4] = cos(heli_q8_B.UnitDelay[2]);
          tmp_1[7] = -sin(heli_q8_B.UnitDelay[2]);
          tmp_1[2] = 0.0;
          tmp_1[5] = sin(heli_q8_B.UnitDelay[2]) / cos(heli_q8_B.UnitDelay[4]);
          tmp_1[8] = cos(heli_q8_B.UnitDelay[2]) / cos(heli_q8_B.UnitDelay[4]);

          /* Gain: '<S4>/Gain1' incorporates:
           *  MATLAB Function: '<Root>/Gyro vector to [pitch rate, elevation rate, travle rate]'
           */
          for (i = 0; i < 3; i++) {
            tmp_2[i] = heli_q8_P.Gain1_Gain[i + 6] * rtb_Switch[5] +
              (heli_q8_P.Gain1_Gain[i + 3] * rtb_Switch[4] +
          ...
          for (k = 0; k < 6; k++) {
            ...
            for (i = 0; i < 6; i++) {
              tmp_4 = 0.0;
              for (i_0 = 0; i_0 < 5; i_0++) {
                tmp_4 += Kk[6 * i_0 + k] * heli_q8_P.C_d[5 * i + i_0];
              }
          ...
          for (i = 0; i < 6; i++) {
            for (i_0 = 0; i_0 < 6; i_0++) {
              Pk_hat[i + 6 * i_0] = 0.0;
              for (k = 0; k < 6; k++) {
                Pk_hat[i + 6 * i_0] += I_0[6 * k + i] * heli_q8_B.UnitDelay1[6 *
                  i_0 + k];
              }

              tmp_4 = 0.0;
              for (k = 0; k < 5; k++) {
                tmp_4 += Kk[6 * k + i_0] * heli_q8_P.C_d[5 * i + k];
              }
            ...
            for (i_0 = 0; i_0 < 5; i_0++) {
              Kk_1[i + 6 * i_0] = 0.0;
              for (k = 0; k < 5; k++) {
                Kk_1[i + 6 * i_0] += Kk[6 * k + i] * heli_q8_P.R_d[5 * i_0 + k];
              }
            }
          }
        ...
        for (i = 0; i < 6; i++) {
          I_1[i] = 0.0;
          Kk_0[i] = 0.0;
          Kk_0[i] += heli_q8_P.B_d[i] * heli_q8_B.Sum_i;
          Kk_0[i] += heli_q8_P.B_d[i + 6] * heli_q8_B.Sum1_h;
          for (i_0 = 0; i_0 < 6; i_0++) {
            I_1[i] += heli_q8_P.A_d[6 * i_0 + i] * xk_hat[i_0];
            I_0[i + 6 * i_0] = 0.0;
            for (k = 0; k < 6; k++) {
              I_0[i + 6 * i_0] += heli_q8_P.A_d[6 * k + i] * Pk_hat[6 * i_0 + k];
            }
          }
        ...
        for (i = 0; i < 6; i++) {
          for (i_0 = 0; i_0 < 6; i_0++) {
            tmp_4 = 0.0;
            for (k = 0; k < 6; k++) {
              tmp_4 += I_0[6 * k + i] * heli_q8_P.A_d[6 * k + i_0];
            }

            heli_q8_DW.UnitDelay1_DSTATE[i + 6 * i_0] = heli_q8_P.Q_d[6 * i_0 +
              i] + tmp_4;
          }
        }
      ...
      heli_q8_PrevZCX.TriggeredSubsystem_Trig_ZCE = heli_q8_B.StreamRead1_o3;
    }
    ...
    for (i = 0; i < 6; i++) {
      for (i_0 = 0; i_0 < 6; i_0++) {
        I_0[i + 6 * i_0] = 0.0;
        for (k = 0; k < 6; k++) {
          I_0[i + 6 * i_0] += heli_q8_B.UnitDelay1[6 * k + i] * heli_q8_P.M[6 *
            i_0 + k];
        }
      }
    }
     ...
     */
    heli_q8_B.Sum1 = heli_q8_B.PitchCounttorad - heli_q8_P.Constant1_Value_o;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Sum = heli_q8_B.ElevationCounttorad - heli_q8_P.Constant_Value_b;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Sum: '<S1>/Subtract'
     */
    rtb_BackmotorSaturation = (heli_q8_B.Sum2 + heli_q8_B.Sum1_h) *
      heli_q8_P.Backgain_Gain;

    /* Gain: '<S1>/Front gain' incorporates:
     *  Sum: '<S1>/Add'
     */
    rtb_FrontmotorSaturation = (heli_q8_B.Sum2 - heli_q8_B.Sum1_h) *
...
void heli_q8_initialize(void)
{
  ...
  heli_q8_PrevZCX.Subsystem6_Trig_ZCE = POS_ZCSIG;
  heli_q8_PrevZCX.TriggeredSubsystem_Trig_ZCE = POS_ZCSIG;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3743578116U);
  heli_q8_M->Sizes.checksums[1] = (525661829U);
  heli_q8_M->Sizes.checksums[2] = (1004582698U);
  heli_q8_M->Sizes.checksums[3] = (2910166051U);

  {
    ...
    systemRan[4] = (sysRanDType *)&heli_q8_DW.Subsystem6_SubsysRanBC;
    systemRan[5] = (sysRanDType *)&heli_q8_DW.TriggeredSubsystem_SubsysRanBC;
    systemRan[6] = (sysRanDType *)&heli_q8_DW.TriggeredSubsystem_SubsysRanBC;
  ...
  heli_q8_M->Sizes.numBlocks = (93);   /* Number of blocks */
