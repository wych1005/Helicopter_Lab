 ...
 * '<S4>'   : 'heli_q8/IMU'
 * '<S5>'   : 'heli_q8/Joystick'
 * '<S6>'   : 'heli_q8/Subsystem3'
 * '<S7>'   : 'heli_q8/Subsystem4'
 * '<S8>'   : 'heli_q8/Subsystem5'
 * '<S9>'   : 'heli_q8/Subsystem6'
 * '<S10>'  : 'heli_q8/Triggered Subsystem'
 * '<S11>'  : 'heli_q8/Subsystem6/Subsystem'
 * '<S12>'  : 'heli_q8/Subsystem6/Subsystem1'
 * '<S13>'  : 'heli_q8/Triggered Subsystem/MATLAB Function'
 */
