  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_DW.e_dot_PWORK.LoggedData
	  ...
	  ;% heli_q8_DW.p_dot_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 24;
	  section.data(8).dtTransOffset = 7;
	
	  ;% heli_q8_DW.t_PWORK.LoggedData
	  section.data(9).logicalSrcIdx = 25;
	  section.data(9).dtTransOffset = 8;
	
	  ;% heli_q8_DW.t_dot_PWORK.LoggedData
  ...
  targMap.checksum0 = 2952369627;
  targMap.checksum1 = 3424750958;
  targMap.checksum2 = 974131995;
  targMap.checksum3 = 618363164;
