...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* '<S2>:1:11' */
    tmp_1[0] = 1.0;
    tmp_1[3] = sin(heli_q8_B.Sum1) * tan(heli_q8_B.Sum);
    tmp_1[6] = cos(heli_q8_B.Sum1) * tan(heli_q8_B.Sum);
    tmp_1[1] = 0.0;
    tmp_1[4] = cos(heli_q8_B.Sum1);
    tmp_1[7] = -sin(heli_q8_B.Sum1);
    tmp_1[2] = 0.0;
    tmp_1[5] = sin(heli_q8_B.Sum1) / cos(heli_q8_B.Sum);
    tmp_1[8] = cos(heli_q8_B.Sum1) / cos(heli_q8_B.Sum);

    /* Gain: '<S4>/Gain1' incorporates:
     *  MATLAB Function: '<Root>/Gyro vector to [pitch rate, elevation rate, travle rate]'
     */
    for (i = 0; i < 3; i++) {
      rtb_TmpSignalConversionAtSFun_b[i] = heli_q8_P.Gain1_Gain[i + 6] *
    ...
    for (i = 0; i < 3; i++) {
      ...
      heli_q8_B.euler_rates[i] += tmp_1[i] * rtb_TmpSignalConversionAtSFun_b[0];
      heli_q8_B.euler_rates[i] += tmp_1[i + 3] *
        rtb_TmpSignalConversionAtSFun_b[1];
      heli_q8_B.euler_rates[i] += tmp_1[i + 6] *
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<S4>/Gain2' */
    for (i = 0; i < 3; i++) {
      rtb_TmpSignalConversionAtSFun_b[i] = heli_q8_P.Gain2_Gain[i + 6] *
     ...
     *  Product: '<S9>/tg_p'
     */
    heli_q8_B.pp = atan(rtb_TmpSignalConversionAtSFun_b[1] /
                        rtb_TmpSignalConversionAtSFun_b[2]);
     ...
     *  Sum: '<S9>/Sum3'
     */
    heli_q8_B.ee = atan(rtb_TmpSignalConversionAtSFun_b[0] / sqrt
                        (rtb_TmpSignalConversionAtSFun_b[1] *
                         rtb_TmpSignalConversionAtSFun_b[1] +
                         rtb_TmpSignalConversionAtSFun_b[2] *
                         rtb_TmpSignalConversionAtSFun_b[2]));
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1737471505U);
  heli_q8_M->Sizes.checksums[1] = (3380440910U);
  heli_q8_M->Sizes.checksums[2] = (2908796701U);
  heli_q8_M->Sizes.checksums[3] = (4046463608U);
  ...
  heli_q8_M->Sizes.numBlockPrms = (652);/* Sum of parameter "widths" */
  return heli_q8_M;
}
