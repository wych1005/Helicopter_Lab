  ...
  ;%**************************
    ...
    ;%
	  ...
	  section.data(23).logicalSrcIdx = 22;
	  section.data(23).dtTransOffset = 103;
	  ...
	  ;% heli_q8_B.Constant3
	  section.data(25).logicalSrcIdx = 24;
	  section.data(25).dtTransOffset = 151;
	  ...
	  section.data(31).logicalSrcIdx = 30;
	  section.data(31).dtTransOffset = 250;
  ...
  targMap.checksum0 = 1737471505;
  targMap.checksum1 = 3380440910;
  targMap.checksum2 = 2908796701;
  targMap.checksum3 = 4046463608;
