 ...
 * C source code generated on : Fri Nov 08 18:14:39 2019
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  srClearBC(heli_q8_DW.Subsystem2_SubsysRanBC);
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  ...
  /* Sum: '<Root>/Sum1' */
  heli_q8_B.Sum1_h = heli_q8_B.Gain[1] - rtb_K[1];

  /* Sum: '<Root>/Sum' */
  heli_q8_B.Sum = heli_q8_B.Gain[0] - rtb_K[0];
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Sum_i = heli_q8_B.ElevationCounttorad - heli_q8_P.Constant_Value;
     ...
     */
    if (rtmIsMajorTimeStep(heli_q8_M)) {
      if (heli_q8_B.StreamRead1_o3 && (heli_q8_PrevZCX.Subsystem2_Trig_ZCE !=
           POS_ZCSIG)) {
        ...
        for (i = 0; i < 5; i++) {
          for (i_0 = 0; i_0 < 6; i_0++) {
            Kk_1[i + 5 * i_0] = 0.0;
            for (iy = 0; iy < 6; iy++) {
              Kk_1[i + 5 * i_0] += heli_q8_P.C_d[5 * iy + i] *
        ...
        for (i = 0; i < 5; i++) {
          for (i_0 = 0; i_0 < 5; i_0++) {
            rtb_Backgain = 0.0;
            for (iy = 0; iy < 6; iy++) {
              rtb_Backgain += Kk_1[5 * iy + i] * heli_q8_P.C_d[5 * iy + i_0];
            }

            tmp[i + 5 * i_0] = heli_q8_P.R_d[5 * i_0 + i] + rtb_Backgain;
          }
        }
        ...
        if (!heli_q8_B.StreamRead1_o3) {
          ...
          for (i = 0; i < 6; i++) {
            for (i_0 = 0; i_0 < 6; i_0++) {
              rtb_Backgain = 0.0;
              for (iy = 0; iy < 5; iy++) {
                rtb_Backgain += Kk[6 * iy + i] * heli_q8_P.C_d[5 * i_0 + iy];
              }
          ...
          /* SignalConversion: '<S12>/TmpSignal ConversionAt SFunction Inport3' incorporates:
           *  Constant: '<S8>/Constant3'
           */
          tmp_1[0] = heli_q8_B.PitchTransferFcn;
          tmp_1[1] = heli_q8_B.ElevationTransferFcn;
          tmp_1[2] = heli_q8_B.TravelTransferFcn;
          tmp_1[3] = heli_q8_B.Sum1;
          tmp_1[4] = heli_q8_B.Sum_i;
          for (i = 0; i < 6; i++) {
            I_1[i] = 0.0;
            for (i_0 = 0; i_0 < 6; i_0++) {
          ...
          for (iy = 0; iy < 6; iy++) {
            ...
            for (i = 0; i < 6; i++) {
              rtb_Backgain = 0.0;
              for (i_0 = 0; i_0 < 5; i_0++) {
                rtb_Backgain += Kk[6 * i_0 + iy] * heli_q8_P.C_d[5 * i + i_0];
              }
          ...
          for (i = 0; i < 6; i++) {
            for (i_0 = 0; i_0 < 6; i_0++) {
              Pk_hat[i + 6 * i_0] = 0.0;
              for (iy = 0; iy < 6; iy++) {
                Pk_hat[i + 6 * i_0] += I_0[6 * iy + i] * heli_q8_B.UnitDelay1[6 *
                  i_0 + iy];
              }

              rtb_Backgain = 0.0;
              for (iy = 0; iy < 5; iy++) {
                rtb_Backgain += Kk[6 * iy + i_0] * heli_q8_P.C_d[5 * i + iy];
              }
            ...
            for (i_0 = 0; i_0 < 5; i_0++) {
              Kk_1[i + 6 * i_0] = 0.0;
              for (iy = 0; iy < 5; iy++) {
                Kk_1[i + 6 * i_0] += Kk[6 * iy + i] * heli_q8_P.R_d[5 * i_0 + iy];
              }
            }
          }
        ...
        for (i = 0; i < 6; i++) {
          I_1[i] = 0.0;
          Kk_0[i] = 0.0;
          Kk_0[i] += heli_q8_P.B_d[i] * heli_q8_B.Sum;
          Kk_0[i] += heli_q8_P.B_d[i + 6] * heli_q8_B.Sum1_h;
          for (i_0 = 0; i_0 < 6; i_0++) {
            I_1[i] += heli_q8_P.A_d[6 * i_0 + i] * xk_hat[i_0];
            I_0[i + 6 * i_0] = 0.0;
            for (iy = 0; iy < 6; iy++) {
              I_0[i + 6 * i_0] += heli_q8_P.A_d[6 * iy + i] * Pk_hat[6 * i_0 +
                iy];
            }
          }
           ...
           *  SignalConversion: '<S12>/TmpSignal ConversionAt SFunction Inport1'
           */
          heli_q8_DW.UnitDelay_DSTATE[i] = I_1[i] + Kk_0[i];
        }
        ...
        for (i = 0; i < 6; i++) {
          for (i_0 = 0; i_0 < 6; i_0++) {
            rtb_Backgain = 0.0;
            for (iy = 0; iy < 6; iy++) {
              rtb_Backgain += I_0[6 * iy + i] * heli_q8_P.A_d[6 * iy + i_0];
            }
        ...
        /* End of Update for UnitDelay: '<S8>/Unit Delay1' */
        heli_q8_DW.Subsystem2_SubsysRanBC = 4;
      }

      heli_q8_PrevZCX.Subsystem2_Trig_ZCE = heli_q8_B.StreamRead1_o3;
    }
    ...
    /* Gain: '<S11>/Gain' */
    for (i = 0; i < 6; i++) {
      heli_q8_B.Gain_f[i] = 0.0;
      for (i_0 = 0; i_0 < 6; i_0++) {
        heli_q8_B.Gain_f[i] += I_0[6 * i_0 + i] * heli_q8_P.v[i_0];
      }
    }
  }
  ...
  heli_q8_B.Sum3[4] = heli_q8_B.Sum_i - heli_q8_B.UnitDelay[2];
  ...
  /* Sum: '<Root>/Sum2' */
  rtb_Backgain = heli_q8_B.Sum + heli_q8_B.Constant1;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_Backgain - heli_q8_B.Sum1_h) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (rtb_Backgain + heli_q8_B.Sum1_h) * heli_q8_P.Backgain_Gain;
...
void heli_q8_initialize(void)
{
  ...
  heli_q8_PrevZCX.Subsystem2_Trig_ZCE = POS_ZCSIG;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3822442980U);
  heli_q8_M->Sizes.checksums[1] = (2358348157U);
  heli_q8_M->Sizes.checksums[2] = (1906200061U);
  heli_q8_M->Sizes.checksums[3] = (269557389U);

  {
    ...
    systemRan[4] = (sysRanDType *)&heli_q8_DW.Subsystem2_SubsysRanBC;
    systemRan[5] = (sysRanDType *)&heli_q8_DW.Subsystem2_SubsysRanBC;
  ...
  heli_q8_M->Sizes.numBlockPrms = (644);/* Sum of parameter "widths" */
  return heli_q8_M;
}
