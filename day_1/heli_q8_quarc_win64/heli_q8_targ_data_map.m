  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_DW.analytic_PWORK.LoggedData
	  section.data(1).logicalSrcIdx = 14;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_DW.differance_PWORK.LoggedData
  ...
  targMap.checksum0 = 1020321783;
  targMap.checksum1 = 1200749380;
  targMap.checksum2 = 335665307;
  targMap.checksum3 = 4016141906;
